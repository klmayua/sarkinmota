          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3 mt-2">
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="size-10 rounded-full border border-white/10 flex items-center justify-center text-text-muted hover:border-gold hover:text-gold transition-all bg-black/40"
              >
